...
const navigation = [
  ...
  { name: 'Events', href: routes.EVENT },
  { name: 'Tickets', href: routes.TICKET },
                  ...
                  {navigation.map((item) => (
                    <a
                      ...
                      className={classNames(
                        item.href === currentRoute.pathname ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
                  ...
                  >
                    {userNavigation.map((item) => (
                      <MenuItem key={item.name}>
                        <a href={item.href} className="block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 data-[focus]:outline-none">
                          {item.name}
                        </a>
                      </MenuItem>
                    ))}
